...
(
	`pfolderid` INTEGER PRIMARY KEY AUTOINCREMENT,
	`title` text,
...
(
	`pfolderid` INTEGER REFERENCES `physical_folders` (`pfolderid`) ON DELETE CASCADE ON UPDATE CASCADE,
	`typeid` INTEGER REFERENCES `item_types` (`typeid`) ON DELETE CASCADE ON UPDATE CASCADE,
...
(
	`tagid` INTEGER REFERENCES `tags` (`tagid`) ON DELETE CASCADE ON UPDATE CASCADE,
	`vitemid` INTEGER REFERENCES `virtual_items` (`vitemid`) ON DELETE CASCADE ON UPDATE CASCADE,
...
(
	`vitemid` INTEGER PRIMARY KEY AUTOINCREMENT,
	`pfolderid` REFERENCES `physical_folders` (`pfolderid`) ON DELETE CASCADE ON UPDATE CASCADE,
